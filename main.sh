...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/wggly/bogelstore/main/"
...
wget -q https://raw.githubusercontent.com/wggly/v3/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
